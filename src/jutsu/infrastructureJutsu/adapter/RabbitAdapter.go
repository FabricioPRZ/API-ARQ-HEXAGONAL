...
var _ repositories.MessageService = (*RabbitMQAdapter)(nil)

func NewRabbitMQAdapter() (*RabbitMQAdapter, error) {
	conn, err := amqp.Dial("amqp://fabricio:fabricio@52.1.54.184")
	if err != nil {
...
func (r *RabbitMQAdapter) PublishEvent(eventType string, jutsu entities.Jutsu) error {
	body, err := json.Marshal(jutsu)
	if err != nil {
